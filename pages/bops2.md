...
<div class="alert-red">
  <h3>IMPORTANT</h3><br/>
  <p>Patches specifically made for /dev/ghostline's server emulator (server URL, disable buddies, temporary fixes) are now obsolete.</p>
  <p>The server (bosrv) is not active anymore and the torch has been passed to <a href="https://github.com/a-blondel/ea-nation-server">EA Nation Server</a>.</p>
